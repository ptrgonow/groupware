...
public interface UserMapper {
    ...
    // 직원 정보를 등록하는 쿼리
    @Insert("INSERT INTO employee (employee_code, name, birth_date, address, department_id, position, status, created_at, username, password) VALUES (#{employeeCode}, #{name}, #{birthDate}, #{address}, #{departmentId}, #{position}, '퇴근', NOW(), #{username}, #{password})")
